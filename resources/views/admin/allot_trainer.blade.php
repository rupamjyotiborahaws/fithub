    ...
    <div class="row">
        ...
        <div class="col-md-4 col-lg-4 col-sm-12 col-sx-12 mb-4">
            ...
            <div style="margin-top:6px;">
                <select class="form-control" style="width:70%; display:inline-block; margin-right:8px;" id="member_id" name="member_id">
        ...
        <div class="col-md-6 col-lg-6 col-sm-12 col-sx-12 mb-4">
            <h5 style="margin:0 0 12px;" class="font-semibold mb-4">Trainers</h5>
        ...
        <div class="col-md-2 col-lg-2 col-sm-12 col-sx-12 mb-4">
